// מאמרים לדוגמה - אותו מערך כמו ב-script.js
const posts = [
    {
        ...
        content: `"מרכבות גדעון", זהו השם שנבחר למבצע הצבאי בו נלחמים חיילנו היקרים בעזה בימים אלה. מבצע גדול אליו התגייסו שוב לוחמי מילואים רבים, אשר אש האמונה והמסירות למען עם ישראל בוערת בליבם.
